...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        public bool ConformX = true; // Conform to screen safe area on X-axis (default true, disable to ignore)
        public bool ConformY = true; // Conform to screen safe area on Y-axis (default true, disable to ignore)
        public bool Logging = false; // Conform to screen safe area on Y-axis (default true, disable to ignore)
