...
#pragma warning disable 0649
        ...
        [SerializeField] [HideInInspector] [Tooltip("If disabled, no popup will be shown when the console window is hidden")]
...
#pragma warning restore 0649
        ...
        public void ShowLogWindow()
        {
            ...
            logWindowCanvasGroup.transform.localScale = Vector3.one;
        ...
        public void HideLogWindow()
        {
            ...
            logWindowCanvasGroup.transform.localScale = Vector3.zero;
            ...
            else
            {
                ...
                for (int i = 0; i < suggestionsCount; i++)
                {
                    ...
                    if (caretArgumentIndex > 0)
                        ...
                        commandSuggestionsStringBuilder.Append(commandSuggestionHighlightStart).Append(matchingCommandSuggestions[i].command)
                    ...
                    if (suggestedCommand.parameters.Length > 0)
                    {
                        ...
                        for (int j = 0; j < suggestedCommand.parameters.Length; j++)
                        {
                            if (caretParameterIndex != j)
                                ...
                                commandSuggestionsStringBuilder.Append(commandSuggestionHighlightStart).Append(suggestedCommand.parameters[j])
                                    .Append(commandSuggestionHighlightEnd);
                        }
                    }
