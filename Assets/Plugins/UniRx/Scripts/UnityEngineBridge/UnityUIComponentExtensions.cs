...
namespace UniRx
{
    public static partial class UnityUIComponentExtensions
    {
        ...
        public static IObservable<Unit> OnClickAsObservableThrottleFirst(this Button button, float delay = 0.5f)
        {
            return button.onClick.AsObservable().ThrottleFirst(TimeSpan.FromSeconds(delay));
        }
        ...
        public static IObservable<bool> OnToggleOnAsObservable(this Toggle toggle)
        {
            return toggle.OnValueChangedAsObservable().DistinctUntilChanged().Where(_ => _);
        }
